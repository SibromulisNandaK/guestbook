...
<div class="main-content-inner">
    <div class="row">
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title">Peserta Pelatihan Akuntansi Masjid</h3>
                    ...
                    <!-- <div class="data-tables datatable-dark"> -->
                        <table class="table table-hover" id="TabelAkuntansiMasjid" style="width:100%;">
                            ...
                            <tbody>
                                ...
                                <tr id="<?php echo $isi->id_undangan?>">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <?php if($isi->status_kehadiran =="Sudah Hadir"){?>
                                            <?php if($isi->opsi1 == "Narasumber"){ ?>
                                                <a href="<?php echo base_url().'index.php/Undangan/cetak_sertifikat_akmn/'.$isi->id_undangan?>"  class="btn btn-dark" title="Download Sertifikat"><i class="fas fa-download"></i></a>
                                                <a href="<?php echo base_url().'index.php/Undangan/cetak_piagam_masjid/'.$isi->id_undangan?>"  class="btn btn-light" title="Download Piagam"><i class="fas fa-mosque"></i></a>
                                            <?php } else {?>
                                                <a href="<?php echo base_url().'index.php/Undangan/cetak_sertifikat_akm/'.$isi->id_undangan?>"  class="btn btn-dark" title="Download Sertifikat"><i class="fas fa-download"></i></a>
                                                <a href="<?php echo base_url().'index.php/Undangan/cetak_piagam_masjid/'.$isi->id_undangan?>"  class="btn btn-light" title="Download Piagam"><i class="fas fa-mosque"></i></a>
                                                <?php }?>
                                        <?php } else {?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"tabindex="-3">
                ...
                <form action="<?=base_url('index.php/Undangan/tambah_peserta_khusus/'.$url.'/'.$function_cont)?>" method="POST">
                    ...
                    <div class="form-group ui-widget"tabindex="-2"> 
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Nama Masjid" id="keterangan" name="keterangan">
                    </div>
                    
                    <div class="form-group">
                                       <!-- <label for="example-search-input" class="col-form-label">Search</label> -->
                        <input class="form-control" type="text" placeholder="Jabatan" id="opsi" name="opsi1">
                    </div>
                    <div class="form-group">
                                       <!-- <label for="example-search-input" class="col-form-label">Search</label> -->
...
<div class="modal fade" id="update" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel">Edit Peserta Pelatihan Akuntansi Masjid</h4>
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            </div>
            <div class="modal-body">
                <form action="<?=base_url().'index.php/Undangan/update_peserta/'.$function_cont.'/'.$url?>" method="post">
                    ...
                    <!-- Jabatan -->
                    <input id="uopsi1" type="text" name="opsi1" class="form-control"><br>
                    <input type="number" class="form-control" name="no_telepon" id="no"><br>
                                       <!-- <label for="example-search-input" class="col-form-label">Search</label> -->
                    <input class="form-control" type="email" id="uemail" name="email"><br>
                    <!-- alamat -->
                    <input type="text" name="opsi2" id="uopsi2" class="form-control"><br>
...
<script>
    ...
    $('#TabelAkuntansiMasjid').DataTable({
        responsive: {
            details: {
